import { Badge, Dropdown, MenuProps, Progress } from "antd";
  ...
  const notificationMenu: MenuProps["items"] = [
    ...
    },
    {
      ...
      label: (
        <Link href="#" legacyBehavior>
          <a>
            <ItemWithIcon icon={User}>user</ItemWithIcon>
          </a>
        </Link>
      ),
    },
    {
      ...
      label: (
        <Link href="#" legacyBehavior>
          <a>
            <ItemWithIcon icon={Mail}>mail</ItemWithIcon>
          </a>
        </Link>
      ),
    },
    {
      ...
      label: (
        <Link href="#" legacyBehavior>
          <a>
            <ItemWithIcon icon={Eye}>eye</ItemWithIcon>
          </a>
        </Link>
      ),
    },
    {
      ...
      label: (
        <Link href="#" legacyBehavior>
          <a>
            <ItemWithIcon icon={Lock}>lock</ItemWithIcon>
          </a>
        </Link>
      ),
    },
    ...
    <div className="d-flex align-items-center gap-3">
      ...
      >
        <a onClick={(e) => e.preventDefault()}>
          <Badge count={5} offset={[-5, 5]}></Badge>
        </a>
      </Dropdown>
    </div>
  );
