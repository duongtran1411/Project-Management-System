...
export default function Backlog() {
  ...
  return (
    <div className="p-6 bg-white min-h-screen">
      ...
      <div className="m-4">
        <h3 className="font-semibold bg-gray-100 p-2 rounded-t-md">
          Backlog (0 work items)
        </h3>
        <div className="border border-t-0 border-gray-200 p-4 text-gray-400">
          Your backlog is empty.
        </div>
        <div className="p-2 border border-t-0 border-gray-200">
