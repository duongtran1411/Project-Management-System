...
import DetailTask from "./detail-task/page";
  ...
  const epicDropdown = (
    <div className="bg-white rounded-lg shadow-lg p-2 min-w-[220px]">
      {epicOptions.map((epic) => (
        <div key={epic.value} className="flex items-center gap-2 px-2 py-1 rounded cursor-pointer hover:bg-gray-50">
          <Checkbox
    ...
    <div className="p-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <Dropdown
          ...
          trigger={["click"]}
        >
          <Button className="flex items-center font-semibold text-gray-700 " icon={null}>
          ...
          <div key={index} className="flex-1 min-w-[300px] bg-white border border-gray-200 rounded-lg shadow-sm px-3 py-4">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500">{filterTasks(column.tasks).length}</span>
              </div>
              {column.title === "TO DO" && (
                <Button
                  type="text"
